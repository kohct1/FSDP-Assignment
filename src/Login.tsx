...
function Login() {
        ...
        return (
            <>
                <div className="w-full h-screen flex justify-center items-center bg-[url(/images/OCBCBackground.jpg)] bg-cover">
                    <div className="w-1/4 md:h-fit h-50% flex flex-col justify-between rounded border-2 pt-8 bg-slate-100">
                        ...
                        <div className="w-full flex bg-gray-300 text-xs px-12 py-4 gap-2 justify-center">
                            <h1>Don't have online banking?</h1>
                            <h1 className="text-blue-600 cursor-pointer hover:text-blue-400" onClick={() => setIsLogin(false)}>Sign up now</h1>
                        </div>
                    </div>
                </div>
            </>
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-[url(/images/OCBCBackground.jpg)] bg-cover">
            <div className="w-1/4 h-fit flex flex-col justify-between rounded border-2 pt-8 bg-slate-100">
                ...
                <div className="w-full flex justify-center bg-gray-300 text-xs px-12 py-4 gap-2">
                    <h1>Already have online banking?</h1>
                    <h1 className="text-blue-600 cursor-pointer hover:text-blue-400" onClick={() => setIsLogin(true)}>Login now</h1>
                </div>
            </div>
        </div>
    );
