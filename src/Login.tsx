        ...
        return (
            <>
                <div className="w-full h-screen flex justify-center items-center bg-[url(/images/OCBCBackground.jpg)] bg-cover">
                    <div className="w-1/4 md:h-fit h-50% flex flex-col justify-between rounded border-2 pt-8 bg-white">
                        ...
                        <div className="w-full flex bg-slate-200 text-xs px-12 py-4 gap-2 justify-center">
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-[url(/images/OCBCBackground.jpg)] bg-cover">
            <div className="w-1/4 h-fit flex flex-col justify-between rounded border-2 pt-8 bg-white">
                ...
                <div className="w-full flex justify-center bg-slate-200 text-xs px-12 py-4 gap-2">
